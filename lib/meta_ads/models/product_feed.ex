...
defmodule MetaAds.Models.ProductFeed do
  use MetaAds.Model
  ...
  field("delimiter", "ProductFeed_delimiter", [
    "AUTODETECT",
    "BAR",
    "COMMA",
    "SEMICOLON",
  ...
  field("ingestion_source_type", "ProductFeed_ingestion_source_type", [
    "primary_feed",
    "supplementary_feed"
  ])
  ...
  field("quoted_fields_mode", "ProductFeed_quoted_fields_mode", ["AUTODETECT", "OFF", "ON"])
  ...
  operation(:get_products, "GET", "products", nil, [
    ...
    %{
      "name" => "error_priority",
      "required" => false,
      "type" => "productfeedproducts_error_priority_enum_param",
      "values" => ["HIGH", "LOW", "MEDIUM"]
    },
    %{
      "name" => "error_type",
      "required" => false,
      "type" => "productfeedproducts_error_type_enum_param",
      "values" => [
  ...
  operation(:create_rules, "POST", "rules", nil, [
    %{"name" => "attribute", "required" => true, "type" => "string"},
    %{"name" => "params", "required" => false, "type" => "map"},
    %{
      "name" => "rule_type",
      "required" => true,
      "type" => "productfeedrules_rule_type_enum_param",
      "values" => [
        "fallback_rule",
        "letter_case_rule",
        "mapping_rule",
  ...
  operation(:create_supplementary_feed_assocs, "POST", "supplementary_feed_assocs", nil, [
    %{"name" => "assoc_data", "required" => true, "type" => "list<map>"}
  ])

  operation(:get_upload_schedules, "GET", "upload_schedules", nil, [])

  operation(:create_upload_schedules, "POST", "upload_schedules", nil, [
    %{"name" => "upload_schedule", "required" => false, "type" => "string"}
  ])
