...
defmodule MetaAds.Models.AdsUserSettings do
  use MetaAds.Model

  field("a_plus_c_survey_seen", "bool", [])
  field("adaptive_geo_excl_banner_seen_ts", "list<map<string, int>>", [])
  field("add_overlays_opt_in_status", "string", [])
  field("adgroup_name_template", "Object", [])
  field("ads_cs_catalog_opt_out_timestamp", "list<map<string, int>>", [])
  field("ads_cs_dynamic_se_opt_in_status", "string", [])
  field("ads_cs_dynamic_se_opt_out_timestamp", "list<map<string, int>>", [])
  field("ads_cs_sitelinks_opt_in_status", "string", [])
  field("ads_cs_sitelinks_opt_out_timestamp", "list<map<string, int>>", [])
  field("ads_destination_optimization_opt_out_timestamp", "list<map<string, int>>", [])
  ...
  field("music_on_reels_opt_in", "list<map<string, string>>", [])
