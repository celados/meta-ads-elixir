...
defmodule MetaAds.Models.AdAccountGet do
  use MetaAds.Model

  field("account_controls", "object", [])
  field("account_currency_ratio_to_usd", "float", [])
  ...
  field("asset_score", "float", [])
  field("assigned_partners", "object", [])
  field("attr_window_deprecation_group", "string", [])

  field("auth_flow_for_trust_tier_state", "AdAccountGet_auth_flow_for_trust_tier_state", [
    "EXPIRED",
    "FAILED",
    "IN_REVIEW",
    "NOT_REQUIRED",
  ...
  field(
    ...
    "AdAccountGet_authorized_country_for_political_ads",
    [
      "AC",
      "AD",
      "AE",
  ...
  field("brand_safety_excluded_topics", "list<AdAccountGet_brand_safety_excluded_topics>", [])
  ...
  field("business_restriction_reason", "AdAccountGet_business_restriction_reason", [
    "BANHAMMER",
    "EMAIL_REQUIRED",
    "NONE"
  ])
  ...
  field("business_verification_status", "AdAccountGet_business_verification_status", [
    "EXPIRED",
    "FAILED",
    "INELIGIBLE",
    "NOT_VERIFIED",
  ...
  field("call_ads_ad_account_similar_advertiser_budget_recommendation", "float", [])
  ...
  field("dynamic_probation_dsl", "float", [])
  ...
  field("flex_single_objective", "AdAccountGet_flex_single_objective", [
    "APP_PROMOTION",
    "GROUP_JOINS",
  ...
  field(
    ...
    "AdAccountGet_marketing_message_enablement_status",
    [
  ...
  field("modeled_reporting_type", "AdAccountGet_modeled_reporting_type", ["IOS14_ACCOUNT", "NONE"])
  ...
  field("segment", "AdAccountGet_segment", ["HAIR", "HEAD", "NULL", "TAIL", "TORSO"])
  ...
  field("stored_balance_status", "AdAccountGet_stored_balance_status", [
    "NEW_USER",
    "POSTPAY",
    "PREPAY",
    "STANDARD"
  ...
  field("tos_accepted", "map<int, int>", [])
  ...
  field("user_tos_accepted", "map<int, int>", [])
  field("users", "object", [])
