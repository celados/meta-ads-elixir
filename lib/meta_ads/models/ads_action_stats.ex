...
defmodule MetaAds.Models.AdsActionStats do
  use MetaAds.Model

  field("1d_click", "string", [])
  field("1d_click_all_conversions", "string", [])
  field("1d_click_first_conversion", "string", [])
  field("1d_ev", "string", [])
  field("1d_ev_all_conversions", "string", [])
  field("1d_ev_first_conversion", "string", [])
  field("1d_passback", "string", [])
  field("1d_sequenced", "string", [])
  field("1d_view", "string", [])
  field("1d_view_all_conversions", "string", [])
  field("1d_view_first_conversion", "string", [])
  field("28d_click", "string", [])
  field("28d_click_all_conversions", "string", [])
  field("28d_click_first_conversion", "string", [])
  field("28d_passback", "string", [])
  field("28d_sequenced", "string", [])
  field("28d_view", "string", [])
  field("28d_view_all_conversions", "string", [])
  field("28d_view_first_conversion", "string", [])
  field("7d_click", "string", [])
  field("7d_click_all_conversions", "string", [])
  field("7d_click_first_conversion", "string", [])
  field("7d_passback", "string", [])
  field("7d_sequenced", "string", [])
  field("7d_view", "string", [])
  field("7d_view_all_conversions", "string", [])
  field("7d_view_first_conversion", "string", [])
