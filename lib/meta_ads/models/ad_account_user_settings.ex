...
defmodule MetaAds.Models.AdAccountUserSettings do
  use MetaAds.Model

  field("acf_should_opt_out_video_adjustments", "bool", [])
  field("aco_sticky_settings", "list<map<string, string>>", [])
  ...
  field("hidden_optimization_tips", "list<map<string, bool>>", [])
  ...
  field("saip_advertiser_setup_optimisation_guidance_state", "list<map<string, string>>", [])
  ...
  field("syd_campaign_trends_objective", "AdAccountUserSettings_syd_campaign_trends_objective", [
    "APP_INSTALLS",
    "BRAND_AWARENESS",
    "EVENT_RESPONSES",
    "LEAD_GENERATION",
